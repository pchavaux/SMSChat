...
namespace SMSChat.Migrations
{
    ...
    [Migration("20250111003802_ChatThread-Attachment-Message-ApplicationUser-Friend")]
    partial class ChatThreadAttachmentMessageApplicationUserFriend
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMSChat.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSChat.Models.Friend", b =>
                {
                    b.HasOne("SMSChat.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
