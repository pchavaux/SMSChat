...
namespace SMSChat.Services
{
        ...
        public class SIPClient
        {
            ...
            private string m_sipUsername = "184942";
            private string m_sipPassword = "y+Rm+OARzI2*";
            ...
            public void Cancel()
            {
                Debug.WriteLine( "Cancelling SIP call to " + m_userAgent.CallDescriptor?.Uri + ".");
                m_userAgent.Cancel();
            }
            ...
            public async Task PutOnHold()
            {
                ...
                Debug.WriteLine( "Local party put on hold");
            }
            ...
            public void TakeOffHold()
            {
                ...
                Debug.WriteLine( "Local party taken off on hold");
            }
            ...
            public Task<bool> BlindTransfer(string destination)
            {
                ...
                {
                    Debug.WriteLine( $"The transfer destination was not a valid SIP URI.");
            ...
            {
                Debug.WriteLine( "Call trying: " + sipResponse.StatusCode + " " + sipResponse.ReasonPhrase + ".");
            }
